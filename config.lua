...
dataPackDirectory = "canary/data-canary"
-- Don't change this unless you know what you're doing
coreDirectory = "canary/data"
...
maxPlayers = 100
serverName = "NaxedOt"
serverMotd = "Welcome to NaxedOt 8!"
statusTimeout = 5 * 60 * 1000
replaceKickOnLogin = true
maxPacketsPerSecond = 25
maxPlayersOnlinePerAccount = 0
maxPlayersOutsidePZPerAccount = 0
