...
function playerLogin.onLogin(player)
	...
	local defaultTown = "NewHaven" -- default town where player is teleported if his home town is in premium area
	local freeTowns = { "Newhaven"} -- towns in free account area
